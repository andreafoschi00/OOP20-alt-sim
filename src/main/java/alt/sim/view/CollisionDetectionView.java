...
public class CollisionDetectionView extends Application {
        ...
        try {
            ...
            EventHandler<MouseEvent> eventMouseClicked = new EventHandler<MouseEvent>() {
                ...
                public void handle(final MouseEvent e) {
                    ...
                    if (rectangleWall.getBoundsInParent().intersects(circle.getBoundsInParent())) {
            ...
            paneRoot.getChildren().addAll(rectangleWall, circle);
    ...
    public static void main(final String[] args) {
        CollisionDetectionView view = new CollisionDetectionView();
        launch(args);
    }
